...
import com.lucenetest.index.IndexDocs;
...
public class SearchFiles {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Query query = new TermQuery(new Term("contents", "run"));
